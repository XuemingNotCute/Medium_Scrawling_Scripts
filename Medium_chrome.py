...
browser = webdriver.Chrome("/Users/admin/Desktop/xxm/chromedriver")

browser.get("https://medium.com/topic/science")
time.sleep(1)
...
#page = requests.get("https://medium.com/topic/culture")
...
result.to_csv('links_science.csv')
